...
const Asr = (() => {
  ...
  async function onInputDeviceChange(): Promise<void> {
    _stopVuMeter();
    await _startVuMeter();
  }
  ...
  async function reloadOllamaModels(): Promise<void> {
  ...
  function switchBackend(val: string): void {
