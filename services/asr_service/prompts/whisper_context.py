# Prior text passed to Whisper to bias recognition toward ATC vocabulary.
# Realistic sentences are more effective than a plain word list because
# Whisper continues the style it sees in the prompt.
ATC_PROMPT = (
