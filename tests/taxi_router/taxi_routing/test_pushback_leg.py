...
def test_known_direction_preserved():
    leg = plan_pushback_leg(
        stand_lat=41.2948,
        stand_lon=2.0796,
        stand_heading_deg=200.0,
        first_wp_lat=41.2950,
        first_wp_lon=2.0800,
        direction_deg=0.0,
    )
...
def test_distance_clamped_to_min():
    ...
    leg = plan_pushback_leg(
        ...
        stand_lon=2.0796,
        stand_heading_deg=200.0,
        first_wp_lat=41.29481,
        first_wp_lon=2.07961,
        direction_deg=0.0,
    )
