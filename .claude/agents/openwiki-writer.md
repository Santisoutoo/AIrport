...
description: Generates and maintains the openwiki/ agent-facing documentation for the AIrport repo. Use to create the wiki from scratch or refresh it incrementally from recent code changes. Inspired by langchain-ai/openwiki but runs on the Claude subscription.
model: sonnet
